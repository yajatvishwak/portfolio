<script>
	const text = `I'm Yajat Vishwakarma, a software engineer with 3 years of experience in distributed systems and production AI. At Eurofins, I architected a computer vision platform that cut processing from 10 hours to 15 minutes and eliminated $1,400/month in GPU costs — now handling 960 images daily. Got promoted to Software Engineer with a perfect 100/100 appraisal and back-to-back Star Performer awards. On the side, I'm building YuzuHire — an AI platform that conducts screening interviews over phone. Before Eurofins, I was at Oracle shipping OCR solutions for Maersk and Berger Paints. I've won hackathons at Google Cloud, MongoDB Atlas, and internally at Eurofins. My stack: C#, Python, TypeScript, .NET, SvelteKit, Azure, Temporal, Docker. I like building hard things and lifting heavy ones.`;
